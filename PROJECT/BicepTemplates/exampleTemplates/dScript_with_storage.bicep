...
resource ProjectStorage 'Microsoft.Storage/storageAccounts@2019-06-01' = {
...
resource dScript 'Microsoft.Resources/deploymentScripts@2019-10-01-preview' = {
  ...
  properties: {
    ...
    storageAccountSettings: {
      storageAccountName: ProjectStorage.name
      storageAccountKey: ProjectStorage.listKeys().keys[0].value
    }
